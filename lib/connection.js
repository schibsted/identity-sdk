 ...
 * @param {Api} api
 * @param {string} email - The email to query status for. It's automatically encoded in base64
 * @return {Promise}
 */
function emailStatus(api, email) {
    return api.get(`/email/${base64(email)}/status`);
}
